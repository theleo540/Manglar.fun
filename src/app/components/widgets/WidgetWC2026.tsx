...
import { FlagHalf } from "../FlagHalf";

/**
 * <WidgetWC2026 /> — banner grande del proyecto WC2026 Streams para el
 * Hero de manglar.fun. Usa useEcosystemWidget("wc2026streams") por
 * dentro, así que siempre muestra el partido real (o el estado vacío
 * real si no hay nada en vivo/programado).
 *
 * Este es el patrón a copiar para el próximo proyecto real, ej:
 *   components/widgets/WidgetNBA.tsx
 *   usando useEcosystemWidget("nba")
 * con el mismo layout de FlagHalf/CTA, solo cambiando textos y colores
 * si aplica.
 */
export function WidgetWC2026() {
  const [muted, setMuted] = useState(true);
  const { data, loading } = useEcosystemWidget("wc2026streams");
